...
8. Публичные импорты: `ug_experiment_calculator/__init__.py`.
9. Метрики добавляются в `ug_experiment_calculator/metrics.yaml`.
10. Воронки добавляются в `ug_experiment_calculator/funnels.yaml` и `ug_experiment_calculator/queries`.
